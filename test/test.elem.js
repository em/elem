...
describe('Elem', function() {
  ...
  describe('generateLoaderJS', function() {
  ...
  describe('simulate', function() {
    ...
    it('renders subelements', function() {
      var domnode = sample.simulate('<sample><sample></sample></sample>');
      console.log(domnode.innerHTML);
    });

    it('renders nested content', function() {
      var domnode = sample.simulate('<wrapper>hello</wrapper>');
      expect(domnode.innerHTML).eq('<!-- generated by /wrapper/ -->\n<span>hello</span>');
    });
