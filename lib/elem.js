...
/**
 * Generates a simple index.html and loader.js 
...
Elem.prototype.loader = function(opts) {
  ...
  // Production build once on start
  ...
  return function(req,res,next) {
    ...
    function handleLoader() {
      ...
      if(!self.cachedLoader) {
        var basepath = path.dirname(req.originalUrl);
        self.cachedLoader = self.generateLoaderJS(basepath);
      }

      res.end(self.cachedLoader);
    }
